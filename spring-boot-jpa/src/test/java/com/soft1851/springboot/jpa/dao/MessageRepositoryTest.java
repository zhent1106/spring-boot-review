...
class MessageRepositoryTest {
    ...
    void findByMsgSummary() {
        System.out.println(messageRepository.findByMsgSummary("测试"));
    }

    @Test
    void findByMsgTextOrMsgSummary() {
        System.out.println(messageRepository.findByMsgTextOrMsgSummary("软件1851","测试"));
    }

    @Test
    void findByMsgTextLike() {
        System.out.println(messageRepository.findByMsgTextLike("安卓"));
    }
